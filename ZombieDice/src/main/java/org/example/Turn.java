...
public class Turn {
    ...
    /**
     * The main body structure for the playing of the turn
     */
    public void playTurn(){
        ...
        while(true){
            ...
            if (option.equals(TURN_OPTION_END_TURN)){
                activePlayer.addToScore(this.score);
                displayEndTurn();
                break;
            }else if (option.equals(TURN_OPTION_ROLL_DICE)){
                moveToActiveDice();
                rollDice();
                displayRoll();
                moveFromActiveDice();
                ...
                System.err.println("Turn roll option error. Contact support.");
            }
    ...
    public void rollDice(){
        for (Dice die : this.activeDice){
            ...
            if (side.equals("Brain")) {
                this.score += 1;
            }
            if (side.equals("Shotgun")){
                this.strikes += 1;
            }
        }
    }
    ...
    private void displayRoll(){
        ...
        System.out.println("Turn Score: " + this.score);
